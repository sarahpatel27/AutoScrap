  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
      ...
      <form onSubmit={handleSubmit} className="space-y-5 rounded-3xl border border-gray-200 bg-white p-6 shadow-xs lg:col-span-2">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h3 className="text-lg font-black text-slate-900 flex items-center gap-2">
              <span>📍 Scrap Valuation Rate:</span>
          ...
          <div className="flex flex-wrap items-center gap-1.5 pt-2 border-t border-gray-100">
            {TARGET_CITIES.map((city) => (
              <button
                ...
                className={`rounded-xl px-3 py-1 text-xs font-black transition cursor-pointer ${
                  selectedCity === city
        ...
        <div>
          ...
          <div className="rounded-2xl border border-[#c9e8d8] bg-[#edf7f2] p-5">
            <div className="flex items-center justify-between">
              ...
              <span className="rounded-md bg-[#0f7b4f] px-2 py-0.5 text-[10px] font-black text-white uppercase">
        ...
        <div className="flex items-center justify-between border-t border-gray-200 pt-4">
          <button
            type="button"
            onClick={handleReset}
            className="rounded-xl border border-gray-300 bg-gray-50 px-4 py-2.5 text-xs font-bold text-gray-700 transition hover:bg-gray-100 cursor-pointer"
          >
          ...
          <button
            type="submit"
            className="rounded-xl border-0 bg-[#0f7b4f] px-6 py-2.5 text-xs font-extrabold text-white shadow-xs transition hover:bg-[#075b3a] cursor-pointer"
          >
      ...
      <div className="space-y-4 rounded-3xl border border-gray-200 bg-linear-to-b from-gray-50 to-white p-6 shadow-xs">
        <div>
          <span className="text-xs font-extrabold uppercase tracking-wider text-[#0f7b4f]">
