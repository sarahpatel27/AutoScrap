        ...
        <div className="mx-auto flex h-full items-center justify-between px-4 sm:px-6">
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="grid h-9 w-9 place-items-center rounded-xl bg-white/10 text-white lg:hidden cursor-pointer"
              type="button"
            ...
            <Link to="/admin/dashboard" className="flex items-center gap-2.5 font-['Manrope'] text-lg font-black text-white">
              ...
              <span className="flex items-center gap-2">
                <span>MyAuto<span className="text-[#0f7b4f]">Scrap</span></span>
                {user?.assignedCity ? (
                  <span className="rounded-md bg-amber-400 px-2 py-0.5 text-[11px] font-black text-slate-950 uppercase shadow-xs">
                    📍 {user.assignedCity} Dealer
                  </span>
                ) : (
                  <span className="rounded-md bg-[#dff46b] px-2 py-0.5 text-[10px] font-black uppercase text-[#082d1c]">
                    Super Admin
                  </span>
                )}
              </span>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={logout}
              className="inline-flex items-center gap-1.5 rounded-xl border border-red-500/30 bg-red-600/80 px-3.5 py-1.5 text-xs font-extrabold text-white transition hover:bg-red-700 cursor-pointer"
              type="button"
            >
